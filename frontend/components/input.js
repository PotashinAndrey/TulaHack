import Component, { html, css, url } from '../class/Component.js';
import { updateChildrenElement, pointerOffset, updateChildrenText } from '../class/DOM.js';
import { drawRipple } from '../class/Material.js';
import UIIcon from './icon.js';

const style = css`
  @import "${url('../styles/color.css', import.meta.url)}";
  :host {
